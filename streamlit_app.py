...
if select_event == 'Manual input':
    bid_quality = st.sidebar.number_input("EMA 10 days", value=100000)
    bid_volume = st.sidebar.number_input("EMA 10 days", value=100000)
    ask_quality = st.sidebar.number_input("EMA 10 days", value=100000)
    ask_volume = st.sidebar.number_input("EMA 10 days", value=100000)
    matching_volume = st.sidebar.number_input("EMA 10 days", value=100000)
    negotiable_volume = st.sidebar.number_input("EMA 10 days", value=100000)
    positive = st.sidebar.number_input("EMA 10 days", value=1)
    negative = st.sidebar.number_input("EMA 10 days", value=0)
    SMA_10_lag = st.sidebar.number_input("EMA 10 days", value=55)
    SMA_20_lag = st.sidebar.number_input("EMA 10 days", value=55)
