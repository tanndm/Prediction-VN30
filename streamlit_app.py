...
if select_event == 'Manual input':
  ...
  for uploaded_file in uploaded_files:
    ...
    bid_volume = st.sidebar.slider('B frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    ask_quality = st.sidebar.slider('A frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    ask_volume = st.sidebar.slider('B frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    matching_volume = st.sidebar.slider('A frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    negotiable_volume = st.sidebar.slider('B frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    positive = st.sidebar.slider('A frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    negative = st.sidebar.slider('B frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    SMA_10_lag = st.sidebar.slider('A frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    SMA_20_lag = st.sidebar.slider('B frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    EMA_10_lag = st.sidebar.slider('A frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    EMA_20_lag = st.sidebar.slider('B frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    EMA_10_lag = st.sidebar.slider('A frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    EMA_20_lag = st.sidebar.slider('B frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    RSI_7d_lag = st.sidebar.slider('A frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    RSI_9d_lag = st.sidebar.slider('B frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
    RSI_14d_lag = st.sidebar.slider('B frequency range (Hz)', min_value=10, max_value=1000, value=(30,400))
